      ...
      <form action="">
       <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          <tr align="center">
            ...
            <td bgcolor="#ffffff">
              <input type="text" name="accepter" style="width:240px;">
            </td>
            <td bgcolor="#ffffff">手机号：</td>
            <td bgcolor="#ffffff">
              <input type="text" name="telphone" style="width:240px;">
            </td>
          </tr>
           ...
           <tr align="center">
            ...
            <td bgcolor="#ffffff" colspan="3">
              <input type="text" name="addr" style="width:605px;">
            </td>
          </tr>
           <tr align="center">
            <td colspan="4">
